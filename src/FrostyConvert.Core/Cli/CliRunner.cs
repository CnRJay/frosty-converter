...
namespace FrostyConvert.Core.Cli;

/// <summary>
/// Shared command-line entry used by the standalone CLI project and by
/// <c>Frosty Converter.exe</c> when launched with arguments.
/// </summary>
public static class CliRunner
{
    ...
    private static void PrintHelp()
    {
        Console.WriteLine(
"""
Frosty Converter — recover editable projects from compiled Frosty / FIFA mods

Usage (pass args to "Frosty Converter.exe", or use the CLI project from source):
  "Frosty Converter.exe" <mod.fbmod> --inspect [--json] [--report out.json] [--extract dir]
  "Frosty Converter.exe" <mod.fifamod> --inspect [--oodle dll] [--json] [--report out.json] [--extract dir]
  "Frosty Converter.exe" <mod.fbmod> -o recovered.fbproject [--oodle dll] [--json] [--report out.json]
  "Frosty Converter.exe" <mod.fifamod> -o recovered.fifaproject [--oodle dll] [FIFA options]
  "Frosty Converter.exe" <proj.fbproject> --inspect-project
